...
public class Goods {
    ...
    private String goodsFullSpecsM;

    private String goodsFullSpecsE;

    private String goodsSpecsM;

    private String goodsSpecsE;

    private Integer isTaobaoGoods;

    private BigDecimal taobaoPrice;

    private Integer isTaobaoPriceChange;

    private BigDecimal distributcommission;
    ...
    public String getZqPdtDesc() {
        return zqPdtDesc;
    }

    public void setZqPdtDesc(String zqPdtDesc) {
        this.zqPdtDesc = zqPdtDesc;
    }
    ...
    public String getGoodsFullSpecsM() {
        return goodsFullSpecsM;
    }

    public void setGoodsFullSpecsM(String goodsFullSpecsM) {
        this.goodsFullSpecsM = goodsFullSpecsM;
    }

    public String getGoodsFullSpecsE() {
        return goodsFullSpecsE;
    }

    public void setGoodsFullSpecsE(String goodsFullSpecsE) {
        this.goodsFullSpecsE = goodsFullSpecsE;
    }

    public String getGoodsSpecsM() {
        return goodsSpecsM;
    }

    public void setGoodsSpecsM(String goodsSpecsM) {
        this.goodsSpecsM = goodsSpecsM;
    }

    public String getGoodsSpecsE() {
        return goodsSpecsE;
    }

    public void setGoodsSpecsE(String goodsSpecsE) {
        this.goodsSpecsE = goodsSpecsE;
    }

    public Integer getIsTaobaoGoods() {
        return isTaobaoGoods;
    }

    public void setIsTaobaoGoods(Integer isTaobaoGoods) {
        this.isTaobaoGoods = isTaobaoGoods;
    }
    ...
    public Integer getIsTaobaoPriceChange() {
        return isTaobaoPriceChange;
    }

    public void setIsTaobaoPriceChange(Integer isTaobaoPriceChange) {
        this.isTaobaoPriceChange = isTaobaoPriceChange;
    }

    public BigDecimal getDistributcommission() {
        return distributcommission;
    }

    public void setDistributcommission(BigDecimal distributcommission) {
        this.distributcommission = distributcommission;
    }
}
